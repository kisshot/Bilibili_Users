...
class BilibiliSpider(scrapy.Spider):
    ...
    headers = {
        ...
        'Referer': 'https://space.bilibili.com/177291194?from=search&seid=' + str(random.randint(10000, 50000))
            #521401
    }
    #
    ...
    def start_requests(self):
        ...
        yield scrapy.http.FormRequest(self.user_url, method='POST', headers=self.headers, formdata={"mid":"177291194"}, callback=self.parse_user, dont_filter = True)
